...
const navLinks = [
    ...
    // { name: "Initial Loading List", route: "initial_loading" },
    // { name: "Vessel Details", route: "vessel_details" },
    // { name: "Final Loading List", route: "final_loading" },
    // { name: "Logs", route: "logs" },
    // { name: "Cebu Reports", route: "cebu_reports" },
    // { name: "EOD Reports", route: "eod_reports" },
